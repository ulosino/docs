...
Now, you'll be asked to enter a description of the operating system. This is a paragraph of text that describes the OS at hand. Refer to [CONTRIBUTING.md](https://github.com/ulosino/.github/blob/main/CONTRIBUTING.md) for a comprehensive assortment of guidelines for writing sound descriptions.

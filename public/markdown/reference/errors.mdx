...
The app has blocked usage of the feature. Often this is because of [low battery performance restrictions](/docs/reference/limited-performance). Try [restoring the default preferences](/docs/preferences/restore).

## `ShareErrorCaught`

The share functionality encountered an error. This error is handled by the [Web Share API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Share_API) and is accompanied with a detailed error code from that API.

> **Note:** This error is only shown in the console.

...
// Begin page
export default function ReferenceDocumentationPage({
  source,
  componentOverrides,
}: OSPageTypes) {
  return (
...
ReferenceDocumentationPage.getLayout = function getLayout(page: ReactElement) {
  return (
    <ApplicationProvider>
      <Layout
...
export const getStaticProps: GetStaticProps<{
  ...
  // Find Markdown files
  const filePath = path.join(`public/markdown/reference`, `${params.slug}.mdx`);
...
export const getStaticPaths = async () => {
  const pageContentPath = path.join(process.cwd(), "public/markdown/reference");

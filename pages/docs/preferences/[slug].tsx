...
import AllKeybindingTables from "components/KeybindingTable";
...
// Begin page
export default function PreferencesDocumentationPage({
  source,
  componentOverrides,
}: OSPageTypes) {
  return (
    <>
      ...
      <MDXProvider>
        <MDXRemote
          {...source}
          components={{ componentOverrides, AllKeybindingTables }}
        />
      </MDXProvider>
    </>
  );
...
PreferencesDocumentationPage.getLayout = function getLayout(
  page: ReactElement
) {
  return (
    <ApplicationProvider>

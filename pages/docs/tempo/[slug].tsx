...
// Begin page
export default function DonationDocumentationPage({
  source,
  componentOverrides,
}: OSPageTypes) {
  return (
...
DonationDocumentationPage.getLayout = function getLayout(page: ReactElement) {
  return (
    <ApplicationProvider>
      <Layout
...
export const getStaticProps: GetStaticProps<{
  ...
  // Find Markdown files
  const filePath = path.join(`public/markdown/tempo`, `${params.slug}.mdx`);
...
export const getStaticPaths = async () => {
  const pageContentPath = path.join(process.cwd(), "public/markdown/tempo");
